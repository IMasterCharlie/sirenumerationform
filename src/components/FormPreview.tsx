  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-3">
        <h1 className="text-[20px] font-bold mb-1">Enumeration Form</h1>
      ...
      <table className="w-full border-collapse border border-black mb-2 text-[13px]">
        <tbody>
          <tr className="h-24">
            <td className="border border-black p-2 w-[20%] align-middle text-left leading-tight">
              Elector’s Name,<br/>
              EPIC, Address<br/>
              (Pre-printed).
            </td>
            ...
            <td className="border border-black p-2 w-[20%] text-center align-middle text-[#d1d5db]">
              QR Code
            </td>
            <td className="border border-black p-2 w-[20%] text-center align-middle leading-tight">
              Old Photo<br/>
              (Pre-printed)
            </td>
            <td className="border border-black p-2 w-[20%] text-center align-middle leading-tight">
      ...
      <table className="w-full border-collapse border border-black mb-2 text-[12px]">
        <tbody>
          <tr>
            <td className="border border-black p-1 w-[45%] align-middle text-left">Date of Birth (DD/MM/YYYY)</td>
          ...
          {[
            ...
            ['Father’s/Guardian’s Name', data.fatherName],
            ['Father’s/Guardian’s EPIC No. (if available)', data.fatherEpic],
            ['Mother’s Name', data.motherName],
            ['Mother’s EPIC No. (if available)', data.motherEpic],
            ['Spouse’s Name (if applicable)', data.spouseName],
            ['Spouse’s EPIC No. (if available)', data.spouseEpic],
          ].map(([label, value], i) => (
